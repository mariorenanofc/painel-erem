...
export default function GabaritosPage() {
  ...
  // 🔥 NOVO ESTADO: Controla o Modal do Gabarito Aberto
  ...
  // 🔥 MÁGICA REAPROVEITADA: Renderiza URLs como links clicáveis na descrição
      ...
      if (parte.match(urlRegex)) {
        return (
          <a
            ...
            className="text-emerald-600 hover:text-emerald-800 font-black underline break-all bg-emerald-50 px-1 rounded transition-colors"
      ...
      <div className="max-w-384 w-full mx-auto p-4 md:p-8 mt-4 relative">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6 pl-2 md:pl-4 border-l-2 border-emerald-200 mb-6 animate-in slide-in-from-top-2">
                        {missoesDoModulo.map((ativ) => {
                          return (
                            <div
                              key={ativ.id}
                              className="bg-white rounded-2xl border border-slate-200 shadow-sm flex flex-col overflow-hidden relative transition-all hover:shadow-md hover:border-emerald-300"
                            >
                              ...
                              <div className="p-5 flex-1 flex flex-col">
                                ...
                                <h4 className="font-bold text-slate-800 text-lg mb-4 leading-tight">
                                  {ativ.titulo}
                                </h4>
                                ...
                                <div className="mt-auto pt-2">
                                  <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-black py-3 px-4 rounded-xl border border-emerald-200 transition-colors shadow-sm"
                                  >
        ...
        {gabaritoAberto && (
          <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh] border-2 border-emerald-400">
              <div className="p-5 bg-emerald-600 flex justify-between items-center text-white shrink-0">
              ...
              <div className="p-6 overflow-y-auto bg-slate-50 custom-scrollbar">
                ...
                <div className="mb-6">
                  <h3 className="font-black text-2xl text-slate-800 mb-2 leading-tight">
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm mb-6">
                  <h4 className="font-black text-slate-400 text-xs uppercase tracking-widest mb-3">
                  ...
                  <div className="mb-6 space-y-3">
                    {["A", "B", "C", "D"].map((letra) => {
                      ...
                      return opcaoTexto ? (
                        <div
                          key={letra}
                          className="flex items-start p-3 rounded-lg border bg-white border-slate-200 opacity-80 cursor-default"
                        >
                          <div className="flex-1 overflow-x-auto">
                            <strong className="text-slate-500 mr-2">
                              {letra})
                            </strong>
                ...
                <div className="bg-emerald-50 p-6 rounded-2xl border-2 border-emerald-200 shadow-inner mb-6">
                  <h4 className="font-black text-emerald-800 text-sm flex items-center gap-2 uppercase tracking-widest mb-4">
                  ...
                  {gabaritoAberto.gabarito?.trim().startsWith("http") ? (
                    <div className="text-center py-6">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-black py-4 px-8 rounded-xl transition-all shadow-md hover:-translate-y-1"
                      >
                        🔗 Abrir Material de Recuperação / Código
                      </a>
                    </div>
                  ) : (
                    <div className="bg-slate-900 rounded-xl p-4 overflow-x-auto custom-scrollbar shadow-lg">
                ...
                {gabaritoAberto.linkClassroom && (
                  <div className="bg-amber-50 border border-amber-300 p-5 rounded-xl shadow-sm text-center">
                    <h4 className="text-amber-800 font-black text-sm flex items-center justify-center gap-2 mb-2">
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-600 text-white font-black py-3 px-8 rounded-lg shadow-sm transition-transform hover:-translate-y-0.5"
                    >
