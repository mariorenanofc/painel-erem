              ...
              alunosFiltrados.map((aluno, index) => (
                ...
                >
                  <td className="p-4 font-medium">
                    ...
                    <div className="mt-1">
                      {aluno.whatsapp ? (
                        <span className="bg-emerald-100 text-emerald-700 text-[10px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1 w-max">
                          <span className="text-xs">📱</span> No Grupo
                        </span>
                      ) : (
                        <span className="bg-red-50 text-red-600 text-[10px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1 border border-red-200 w-max">
                  ...
                  <td className="p-4 text-center">
                    <div className="flex items-center justify-center gap-3">
                      ...
                      {atualizandoMatricula === aluno.matricula ? (
                        ...
                        <select
                          className="bg-white border border-slate-300 text-slate-700 text-xs rounded p-1.5 focus:outline-none focus:border-emerald-500 cursor-pointer shadow-sm w-37.5"
                          value=""
                          onChange={(e) =>
